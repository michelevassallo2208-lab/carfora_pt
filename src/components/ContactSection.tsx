  ...
  return (
    <section id="contatti" className="section-padding bg-dark relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        <div className="absolute top-0 left-0 w-1/2 h-full" style={{ background: "var(--gradient-hero)" }} />
      ...
      <div className="container-custom relative">
        ...
        <div className="section-shell bg-background/90 border border-primary/15 px-6 sm:px-10 md:px-12 py-10 md:py-12">
          <div className="grid lg:grid-cols-2 gap-8 md:gap-12">
            {/* Contact Form */}
            <div className="glass-gradient rounded-2xl p-6 md:p-8 shadow-card border border-primary/10">
            ...
            <div className="space-y-6 md:space-y-8">
              ...
              {/* Social Links */}
              <div className="p-5 md:p-6 rounded-xl bg-gradient-to-r from-primary/25 to-primary/15 border border-primary/30 shadow-card">
              ...
              {/* Free Trial CTA */}
              <div className="text-center p-6 md:p-8 rounded-2xl bg-gradient-to-br from-primary to-teal-light text-primary-foreground shadow-card">
